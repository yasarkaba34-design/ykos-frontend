      ...
      {apiSynthesis && (
        <div style={{ ...cardStyle, background: "rgba(255, 215, 0, 0.08)", border: "1.5px solid #ffd700" }}>
          ...
          <div style={{ fontSize: "0.7rem", color: "#888", fontStyle: "italic" }}>
            📚 Kaynak: {apiSynthesis.sourceVolume || "ykos.com.tr API Veri Katmanı"}
          </div>
        </div>
      )}
